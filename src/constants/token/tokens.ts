...
const { MAINNET }: {MAINNET: number} = ChainId
...
export const mainnetTokens = defineTokens({
  ...
  bnb: new Token(MAINNET, '0x0f933Dc137D21cA519ae4C7E93f87a4C8EF365Ef', 18, 'BNB', 'BNB', 'https://www.binance.com/'),
  cake: new Token(
    MAINNET,
  ...
  rch: new Token(
    MAINNET,
    '0x116dc328f6962C5defE32D17Ef8B118d56B77E88',
    18,
    'RCH',
    'RCH Token',
    'https://powerpool.finance/',
  ...
  tnm: new Token(
    MAINNET,
    '0x938BCe03532A3845Ec0aB75069E3d84f9cd2826f',
    18,
    'TNM',
    'TNM Token',
    'https://powerpool.finance/',
...
const tokens = () => {
  ...
  if (parseInt(chainId as string, 10) === 336) {
